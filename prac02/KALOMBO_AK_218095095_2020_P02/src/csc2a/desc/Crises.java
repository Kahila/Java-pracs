...
public class Crises{
  ...
  */
  ...
  public static void createEventTwo() {
      ...
      // System.out.printf("what is the Category of event 1 ? ");
      // Category = input.nextLine();
      // System.out.printf("what is the severity level of event (scale 1-10) 1 ? ");
      // Severity = Integer.parseInt(input.nextLine());
      // if (Severity > 10) {
      //     System.out.println("the severity level is above 10 and therefor will be set to 10 !!");
      //     Severity = 10;
      // }
      // totSeverity = Severity;
      // CrisesEvent = new Event(1, eventName, Category, Severity, true);
      ...
      // // Creating event two
      // // input = new Scanner(System.in);
      // System.out.printf("what is the name of event  2 ? ");
      // eventName = input.nextLine();
      // System.out.printf("what is the Category of event 2 ? ");
      // Category = input.nextLine();
      // System.out.printf("what is the severity level of event (scale 1-10) 2 ? ");
      // _Severity = input.nextLine();
      // Severity = Integer.parseInt(_Severity);
      // if (Severity > 10) {
      //     System.out.println("the severity level is above 10 and therefor will be set to 10 !!");
      //     Severity = 10;
      // }
